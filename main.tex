...
\maketitle
Nota importante: Para seguir el orden de la ecuaciones de Gali (2015), estas se encuentran por el título que corresponde a la ecuación del libro, es decir, el título de la subsección que dice '""Ecuación (n): ...""' corresponde a la ecuación (n) del libro.
%========================================
